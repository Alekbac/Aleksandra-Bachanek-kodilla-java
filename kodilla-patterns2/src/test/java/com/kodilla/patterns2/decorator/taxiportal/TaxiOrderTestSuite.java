...
public class TaxiOrderTestSuite {
    ...
    public void testTaxiNetworkGetDescription(){
        //Given
        TaxiOrder theOrder = new BasicTaxiOrder(); //utworzenie delegata
        theOrder = new TaxiNetworkOrderDecorator(theOrder); //tworzony jest dekorator (i przypisywany do tej samej zmiennej co wcześniej delegat
        //When
        String description = theOrder.getDescription();
        //Then
